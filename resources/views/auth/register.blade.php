...
<div class="container my-16">
    <div class="mx-60 border rounded-lg">
        <div class="bg-gray-100 py-3 pl-8 text-xl text-gray-500">{{ __('Register') }}</div>
            <hr>
                ...
                <div class="card-body py-4 px-10">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="grid grid-cols-2 mb-3">
                            <label for="name" class="col-md-4 col-form-label text-md-end text-gray-500 text-right pr-16">{{ __('Name') }}</label>
                        ...
                        <div class="grid grid-cols-2 mb-3">
                            <label for="email" class="col-md-4 col-form-label text-md-end text-gray-500 text-right pr-16">{{ __('Email Address') }}</label>
                        ...
                        <div class="grid grid-cols-2 mb-3">
                            <label for="password" class="col-md-4 col-form-label text-md-end text-gray-500 text-right pr-16">{{ __('Password') }}</label>
                        ...
                        <div class="grid grid-cols-2 mb-3">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-end text-gray-500 text-right pr-16">{{ __('Confirm Password') }}</label>
                        ...
                        <div class="grid grid-cols-2 mb-0">
                            ...
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="bg-blue-700 px-4 py-2 rounded">
                                    <p class="text-white">{{ __('Register') }}</p>
                                </button>
                            </div>
                        </div>
                    </form>
