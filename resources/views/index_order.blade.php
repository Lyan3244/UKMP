...
<div class="container mt-7 mx-auto md:px-12">
    ...
    <hr>
    <div class="px-2 pt-2">
        <a href="{{route('dashboard')}}" class="text-blue-700 hover:text-gray-500"> Dashboard</a> <span class="text-gray-500">> Daftar Pesanan</span>
    </div>
    ...
    <div class="mx-auto border rounded-md w-4/6">
        ...
        <p class="py-1 text-gray-500">Detail Pemesanan Buku :</p>
    @foreach($order->transactions as $transaction)
        <p class="py-1 text-gray-500">Judul Buku yang dibeli : {{$transaction->product->name}}</p>
        <p class="py-1 text-gray-500">Banyak Buku yang dibeli : {{$transaction->amount}} pcs</p>
        @php
            $total_price = $transaction->product->price * $transaction->amount;
        @endphp
        <p class="py-1 text-gray-500">Total Pembayaran  : Rp{{$total_price}}</p>
        <hr>
    @endforeach
        <p class="py-1 font-semibold text-gray-500"> Status Pembayaran :
