        ...
        <div class="bg-gray-100 py-3 flex items-center justify-center text-xl rounded-t-lg text-gray-500">
            ...
            <hr>
                <div class="card-header h-100 text-base font-normal mx-10 my-5">
                    ...
                    @csrf
                        <label class="text-sm font-medium text-gray-600 dark:text-white">Nama</label><br>
                        <input class="my-2 bg-gray-50 border border-gray-300 text-gray-600 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" type="text" name="name" value="{{$user->name}}"><br>
                        <label class="text-sm font-medium text-gray-600 dark:text-white">Email</label><br>
                        <input class="my-2 bg-gray-50 border border-gray-300 text-gray-600 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" type="text" name="email" value="{{$user->email}}"><br>
                        <label class="text-sm font-medium text-gray-600 dark:text-white">Telepon</label><br>
                        <input class="my-2 bg-gray-50 border border-gray-300 text-gray-600 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" type="text" name="telepon" value="{{$user->telepon}}"><br>
                        <label class="text-sm font-medium text-gray-600 dark:text-white">Kata Sandi</label><br>
                        <input class="my-2 bg-gray-50 border border-gray-300 text-gray-600 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" type="password" name="password"><br>
                        <label class="text-sm font-medium text-gray-600 dark:text-white">Konfirmasi Kata Sandi</label><br>
                        <input class="mt-2 mb-5 bg-gray-50 border border-gray-300 text-gray-600 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" type="password" name="password_confirmation"><br>
                        <div class="pb-8">
