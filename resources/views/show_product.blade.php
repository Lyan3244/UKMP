    ...
    <a href="{{route('index_product')}}" class="text-blue-700 hover:text-gray-500"> Toko Buku</a> <span class="text-gray-500">> Tambah Keranjang</span>
        ...
        <div class="grid grid-cols-1 place-items-center">
            <div class="grid grid-cols-2 gap-4 border rounded-lg h-auto w-3/6">
                ...
                <div class="py-3 pr-3">
                    <h1 class="text-xl font-semibold pt-2">Rp : {{$product->price}}</h1>
                    <p class="text-md py-2">Detail Buku : {{$product->description}}</p>
                    <p class="text-md font-semibold py-2">Stok : {{$product->stock}}</p>
...
<button class="">
    <a href="https://api.whatsapp.com/send/?phone=085258284873&text&type=phone_number&app_absent=0">
    <img src="https://cdn-icons-png.flaticon.com/512/471/471715.png" alt="" class="w-14 opacity-60 pb-5 pr-5">
    </a>
</button>
</div> 
</body>
